/*A classe Menu serve como a interface principal do usuário, unindo todas as funcionalidades 
da classe Application. Ela permite que o usuário visualize suas informações e atualize-as através de inputs. */
...
public class Menu extends JFrame {
    ...
    public Menu() {
        ...
        setTitle("SGSA - Sistema de Gestão Escolar");
        Color backgroundColor = Color.decode("#1d334a");
        ...
        //Texto da Tela
        JLabel text = new JLabel("<html><div style='text-align: center;'>SISTEMA DE GESTÃO ESCOLAR</div></html>");
        ...
        managerButton.setBackground(Color.decode("#F8F8FF"));
        add(managerButton);

        JButton aboutButton = new JButton("Sobre");
        aboutButton.setBounds(490 , 585, 300 , 80);
        aboutButton.setBackground(Color.decode("#F8F8FF"));
        add(aboutButton);
    ...
    class About extends JFrame {
        public About() {
            ...
            String aboutText = "<html><div style='text-align: center;'>SISTEMA DE GESTÃO ESCOLAR</div><br>" +
                    ...
                    "Conforme foi solicitado como atividade pela Cruzeiro do Sul. " +
                    "Tanto alunos quanto professores podem utilizar o sistema para buscar informações relacionadas a suas aulas.</div>" +
                    "<div style='text-align: right; margin-right: 20px;'>Desenvolvido por @Gabriel Martins Araujo.</div></html>";
            ...
            goBackButton.setBackground(Color.decode("#F8F8FF"));
            add(goBackButton);
    ...
    class ProfessorFrame extends JFrame{
        public ProfessorFrame() {
            ...
            infoButton.setBackground(Color.decode("#F8F8FF"));
    ...
    class ManagerFrame extends JFrame{
        public ManagerFrame(){
            ...
            logInButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
    ...
    class ProfessorRegister extends JFrame{
        ...
        public ProfessorRegister(){
            ...
            registerButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
    ...
    class ProfessorFinder extends JFrame{
        ...
        public ProfessorFinder(){
            ...
            searchButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
    ...
    class ProfessorCourseRomove extends JFrame{
        ...
        public ProfessorCourseRomove(){
            ...
            removeButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
    ...
    class ProfessorCourseAdd extends JFrame{
        ...
        public ProfessorCourseAdd(){
            ...
            addButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
            goBackButton.setBounds(404 , 508, 224 , 78);
            goBackButton.setBackground(Color.decode("#F8F8FF"));
            add(addButton);
    ...
    class ProfessorDelete extends JFrame{
        ...
        public ProfessorDelete(){
            ...
            deleteButton.setBackground(Color.decode("#F8F8FF"));
            JButton goBackButton = new JButton("Voltar");
            goBackButton.setBounds(418 , 662, 151 , 40);
            goBackButton.setBackground(Color.decode("#F8F8FF"));
            add(deleteButton);
